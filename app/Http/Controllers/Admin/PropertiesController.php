...
class PropertiesController extends Controller
{
    public function index(Request $request)
    {
        ...
        $city = '';
        $area = '';
        $viewFile = 'admin.vendor_property_listing';
        $typeProcess = array();
            ...
            $ven = Inquiry::getVendorInquires(1,$subCate,$vendor,$listing,$city,$area);

            
            //Grab all the inquires
            $vendorList = VendorListing::getAllListing(1,$subCate,Sentinel::getUser()->id,$listing,$city,$area);
        ...
        // $city_info = DB::table('pincode')->get()->toArray();
         ...
         return view('admin.vendor_property_listing')->with('area_info',$area_info)->with('city_info',$city_info)->with('vendorList',$vendorList)->with('cate',$cate)->with('subCate',$subCate)->with('vendor',$vendor)->with('listing',$listing)->with('type',$type)->with('ven',$ven)->with('venListing',$venListing)->with('typeProcess',$typeProcess)->with('city',$city);
    }
    ...
    public function create(Request $request,$vl_id="")
    {
      ...
      $type1 = $_POST['super_area']['type'][0];
        ...
        return redirect('admin/vendor_properties');
    }
    ...
    public function show(VendorListing $vendorListing)
    {
        ...
        return view('admin.property_add',compact('city_info'));
    }
