       ...
       <div class="row">
           <div class="col-sm-8 product-listing-left">
             ...
             <div class="searchbox  s-box"  data-spy="affix" >
                    <form>
                        <input type="text" name="s_key" id="s_key" class="s_key" value="<?php echo e($s_key); ?>" onkeyup="getPredefineSelection()" placeholder="Requirement">                
                  <select name="s_city" id="s_city"  class="select2">
                        ...
                        <?php if(!empty($city_info)): ?>
                         ...
                         <?php if(isset($s_city) && $d->City_Name == $s_city): ?>
                        ...
                        <?php
                            if (!$result->isEmpty()) {
                                ...
                                foreach ($result as $key => $value) {
                                 ...
                                 ?>
                                    <?php if($kk % 2 == 0 && $value->l_category == '4' && $value->l_status == '1'): ?>
                                    <?php elseif($kk % 2 != 0 && $value->l_category == '4' && $value->l_status == '1'): ?>
                                        <div class="col-sm-12">
                                    <?php endif; ?>
                                    <?php
                                    $check = '';
                                    ...
                                    <?php if($value->l_category == '1' && $value->l_status == '1'): ?>
                                    <div class="h-listing-box">
                                        ...
                                        foreach ($files as $key => $values) { ?>
                                                   <?php if($value->l_prime == 1){ ?>
                                                    ...
                                                    <div class="listing-img-pro">
                                                      ...
                                                      <img src="<?php echo e($directory); ?>/<?php echo e($values); ?>" alt="Popular Listing">
                                                    </div>
                                            <?php } else { ?>
                                                  <div class="listing-img-pro">
                                           ...
                                           <?php  } ?> 
                                            ...
                                            ?>    
                                            <div class="listing-img-pro">
                                              <img src="<?php echo e($directory1.$img); ?>" alt="Popular Listing">
                                            </div>
                                            <?php
                                        } ?>
                                            <div class="like" onclick="saveListing('listing_<?php echo e($value->vl_id); ?>')">
                                        ...
                                        <div class="content">
                                            <div class="detailtab mainhead">
                                                      <?php if(isset($value->Vl_id) && $value->url_name != ""): ?>
                                                      <?php
                                                          if ($check == '1') { ?>
                                                              <a href="detail/<?php echo e($value->url_name); ?>" class="onclick"><?php echo e($value->l_title); ?></a>
                                                          <?php } else { ?>
                                                              <a href="#" data-id="detail/<?php echo e($value->url_name); ?>" class="onclick" data-toggle="modal" data-target="#myOTP"><?php echo e($value->l_title); ?></a>
                                                          <?php }
                                                      ?>
                                                      <?php else: ?>
                                                      <?php
                                                          if ($check == '1') { ?>
                                                              <a href="detail/<?php echo e($value->url_name); ?>" class="onclick"><?php echo e(ucfirst($value->l_title)); ?></a>
                                                          <?php } else { ?>
                                                              <a href="#" data-id="detail/<?php echo e($value->url_name); ?>" class="onclick" data-toggle="modal" data-target="#myOTP"><?php echo e(ucfirst($value->l_title)); ?></a>
                                                          <?php }
                                                      ?>
                                                      <?php endif; ?>
                                                            ...
                                                            if(($value->l_category) == 1){
                                                              if (($value->l_sub_category) == 1) { ?>
                                                               <li><button>Offices & shop</button></li> <?php
                                                                    ...
                                                                    if($value->shop_price){ ?>
                                                                    <li><button class="shop" id="<?php echo e($value->vl_id); ?>" data-id="<?php echo e($value->vl_id); ?>" data-shop_price="<?php echo e($value->shop_price); ?>" data-shop_area="<?php echo e($value->shop_area); ?>" data-shop_washroom="<?php echo e($value->shop_washroom); ?>" data-shop_floor="<?php echo e($value->shop_floor); ?>" data-shop_car_parking="<?php echo e($value->shop_car_parking); ?>">Shop</button></li>
                                                                    <?php } 
                                                      ...
                                                      <div class="detiltab-txt">
                                                        <div class="sqrft">
                                                          <ul class="detailtab2 detailtab2_<?php echo $w ?>">
                                                            ...
                                                            ?>
                                                            <li class="shop_sqyrd" style="display: none;"><button><?php echo e($value->shop_area); ?> Sqyrd</button></li>
                                                          </ul>
                                                        </div>
                                                        <div class="detail detail2_<?php echo $w ?>">
                                                          ...
                                                          <?php $__currentLoopData = $masterArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="property_detail" id="property_detail_<?php echo $w?>_<?php echo $k?>_<?php echo $ans1?>">
                                                              <?php } else { ?>
                                                                <div class="property_detail" id="property_detail_<?php echo $w?>_<?php echo $k?>_<?php echo $ans1?>" style="display: none;">
                                                                  <?php } ?>
                                                                  <a href="detail/<?php echo e($value->url_name); ?>">
                                                                    <div class="www">
                                                            <?php if($value->l_sub_category == 1): ?>
                                                            <span> 
                                                              <?php $__currentLoopData = $vv['super_area']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <small>Built Up area</small><?php echo e($details); ?> sqft
                                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </span>
                                                            <?php else: ?>
                                                            <span> 
                                                              <?php $__currentLoopData = $vv['super_area']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <small>Built Up area</small><?php echo e($details); ?> sqyrd
                                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </span>
                                                            <?php endif; ?>
                                                            ...
                                                            <span>
                                                              ...
                                                              <small>Status</small><?php echo e($value->status); ?>

                                                              
                                                            </span>
                                                            <span>
                                                              
                                                              <small>Floor</small><?php echo e($value->floor); ?>

                                                              
                                                            </span>
                                                            <span>
                                                             <?php $__currentLoopData = $vv['transaction_type']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                              ...
                                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <?php if($value->shop_price && $value->vl_id): ?>

                                                              <div class="detail shop_info" id="<?php echo e($value->vl_id); ?>">
                                                                   <input type="hidden" class="hdnvalue" value="<?php echo e($value->vl_id); ?>" >
                                                                    <span>
                                            ...
                                            <a href="detail/<?php echo e($value->url_name); ?>"><p style="color:black;">
                                              <?php echo e(App\Http\Controllers\ListingController::getExcerpt($value->l_description)); ?></p></a>
                                            <div class="reranum">Rera No: 
                                              ...
                                              <?php echo e($value->rera_number); ?>

                                              </a>
                                            </div>
                                            <div class="rating">
                                                <?php for($i = 1; $i <= 5; $i++): ?>
                                                    <?php if($i <= $value->l_view): ?>
                                                        <i class="fa fa-star"></i>
                                                    <?php else: ?>
                                                        <i class="fa fa-star-o"></i>
                                                    <?php endif; ?>
                                                <?php endfor; ?>
                                                <span>( <?php echo e($value->l_view); ?> count )</span>
                                            </div>
                                            <div class="address">
                                                <i class="fa fa-map-marker"></i> <?php echo e($value->l_title); ?> , <?php echo e($value->l_nearby); ?>

                                            </div>
                                        </div>
                                  
                              <?php elseif($value->l_category == '5'): ?>
                              <div class="col-sm-6">
                              <div class="h-listing-box skills">
                              <div class="content "> 
                              <h4>Name :<?php echo e($value->first_name .' '.$value->last_name); ?></h4> 
                              <div class="row">
                              <div class="col-sm-6"><p>Skill :<?php echo e($value->name); ?></p></div>
                              <div class="col-sm-6"><p>Contact :<?php echo e($value->Phone); ?></p></div>
                              <div class="col-sm-6"><p>Age : <?php echo e($value->age_details); ?></p></div>
                              <div class="col-sm-6"><p>Experiance : <?php echo e($value->experience_details); ?><p></div>
                              <div class="col-sm-6"><p>Adhar : <?php echo e($value->adharnumber_details); ?></p></div>
                              </div>
                              </div>
                              </div>
                              </div>
                                    <?php elseif($value->l_category == '4' && $value->l_status == '1'): ?> 
                                    <div class="col-sm-12">
                                    <div class="h-listing-box">
                                      ...
                                      if(is_dir($directory) && count(glob("$directory/*")) !== 0){
                                        ...
                                        <?php if($value->l_prime== 1){ ?>
                                                    <div class="listing-img-pro">
                                                      ...
                                                      <img  src="<?php echo e(url('/')); ?>/public/images/<?php echo e($value->vl_id); ?>/featured_image/featured_image.jpg" alt="featured_image">
                                                    </div> 
                                              <?php } else {  ?>
                                          ...
                                          <?php } } else { ?>
                                          <img src="<?php echo e(url('/')); ?>/public/images/noimage.png"  class="prodctimg">
                                          <?php } ?>
                                        ...
                                        <div class="content">
                                             <a href="detail/<?php echo e($value->url_name); ?>">
                                            <?php if($value->l_title == ""): ?>

                                             <h4><?php echo e(ucfirst($value->url_name)); ?></h4>
                                             <?php else: ?>
                                             <h4><?php echo e(ucfirst($value->l_title)); ?></h4>

                                             <?php endif; ?>
                                           </a>
                                        </div>
                                         <?php if($_GET['s_category'] == '4'){ ?> 
                                         <?php if($value->l_category==4): ?>
                                        <?php $__currentLoopData = explode(',', $value->l_sub_category); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                           
                                            <span class="bbg">
                                            <?php echo e(ucfirst($typeProcess[$info])); ?>
                                     ...
                                     <?php } ?>
                                      ...
                                      <div class="address">
                                        <a href="detail/<?php echo e($value->url_name); ?>">
                                          <i class="fa fa-map-marker"></i> <?php echo e($value->l_nearby); ?>
                                    ...
                                    <?php if($value->l_category == '1' && $value->l_status == '1'): ?>
                                    <div class="h-listing-box">
                                      <a href="detail/<?php echo e($value->url_name); ?>" class="onclick">
                                        <figure>
                                            <?php
                                            ...
                                            ?>
                                            <img src="<?php echo e($directory.$img); ?>" alt="Popular Listing">
                                            <div class="like" onclick="saveListing('listing_<?php echo e($value->vl_id); ?>')">
                                                <i class="fa fa-heart"></i>
                                            </div>
                                        </figure>
                                        ...
                                        <div class="content">
                                            <?php if(isset($value->url_name) && $value->url_name != ""): ?>
                                            <?php
                                                if ($check == '1') { ?>
                                                    <a href="detail/<?php echo e($value->url_name); ?>" class="onclick"><h4><?php echo e($value->l_title); ?></h4></a>
                                                <?php } else { ?>
                                                    <a href="#" data-id="detail/<?php echo e($value->url_name); ?>" class="onclick" data-toggle="modal" data-target="#myOTP"><h4><?php echo e($value->l_title); ?></h4></a>
                                                <?php }
                                            ?>
                                            <?php else: ?>
                                            <?php
                                                if ($check == '1') { ?>
                                                    <a href="detail/<?php echo e($value->vl_id); ?>" class="onclick"><h4><?php echo e($value->l_title); ?></h4></a>
                                                <?php } else { ?>
                                                    <a href="#" data-id="detail/<?php echo e($value->vl_id); ?>" class="onclick" data-toggle="modal" data-target="#myOTP"><h4><?php echo e($value->l_title); ?></h4></a>
                                                <?php }
                                            ?>
                                            <?php endif; ?>
                                            <a href="detail/<?php echo e($value->url_name); ?>" class="onclick"><p><?php echo e(App\Http\Controllers\ListingController::getExcerpt(ucfirst($value->l_description))); ?></p></a>
                                            <div class="rating">
                                                <?php for($i = 1; $i <= 5; $i++): ?>
                                                    <?php if($i <= $value->l_view): ?>
                                                        <i class="fa fa-star"></i>
                                    ...
                                    <?php elseif($value->l_category == '2' && $value->l_status == '1'): ?>
                                     <div class="h-listing-box">
                                        ...
                                        <div class="content">
                                            ...
                                            <?php
                                                if ($check == '1') { ?>
                                                    <a href="detail/<?php echo e($value->vl_id); ?>" class="onclick"><h4><?php echo e(ucfirst($value->l_title)); ?></h4></a>
                                                <?php } else { ?>
                                                    <a href="#" data-id="detail/<?php echo e($value->vl_id); ?>" class="onclick" data-toggle="modal" data-target="#myOTP"><h4><?php echo e($value->l_title); ?></h4></a>
                                                <?php }
                                            ?>
                                            <?php endif; ?>
                                            <a href="detail/<?php echo e($value->url_name); ?>" class="onclick">
                                            <p><?php echo e(App\Http\Controllers\ListingController::getExcerpt(ucfirst($value->l_description))); ?></p>
                                          </a>
                                            <div class="rating">
                                                <?php for($i = 1; $i <= 5; $i++): ?>
                                                    <?php if($i <= $value->l_view): ?>
                                            ...
                                            <div class="address">
                                                <i class="fa fa-map-marker"></i> <?php echo e(ucfirst($value->l_nearby)); ?>

                                            </div>
                                        </div>
                                    </div>
                                     <?php elseif($value->l_category == '3' && $value->l_status == '1'): ?>
                                     <div class="h-listing-box">
                                        <figure>
                                            <?php
                                                $directory = "public/images/".$value->vl_id."/featured_image/";
                                          ...
                                          <?php } ?>
                                          <?php } else { ?>
                                            <img src="<?php echo e($directory_no_image); ?>" alt="Popular Listing">
                                            <?php } ?>
                                            <div class="like" onclick="saveListing('listing_<?php echo e($value->vl_id); ?>')">
                                                <i class="fa fa-heart"></i>
                                            </div>
                                        ...
                                        <div class="content">
                                            ...
                                            ?>
                                            <?php endif; ?>
                                            <a href="detail/<?php echo e($value->url_name); ?>" class="onclick"><p><?php echo e(App\Http\Controllers\ListingController::getExcerpt(ucfirst($value->l_description))); ?></p>
                                            </a>
                                            <div class="rating">
                                                <?php for($i = 1; $i <= 5; $i++): ?>
                                                    <?php if($i <= $value->l_view): ?>
                            ...
                            <?php } else { ?>
                            <div class="content">
                        <div class="text-center" style=" margin-top: 80px;"><img src="<?php echo e(url('/')); ?>/public/images/no-result-found.jpg" alt="noimage"></div>
...
$(document).ready(function(){
 $('.user').blur(function(){
  ...
  var _token = $('input[name="_token"]').val();
   $.ajax({
    url:"<?php echo e(url('/')); ?>/check_phone",
    method:"POST",
    ...
    jQuery("#l_category").on('change',function(){
        $.ajax({
            type:"GET",
            dataType: "json",
            url:"<?php echo e(url('/getType')); ?>?category="+this.value,
...
<script>
      function getPredefineSelection() {
        ...
        $.ajax({
            type:"GET",
            dataType: "json",
            url:"<?php echo e(url('/getSelectionInfo')); ?>?keyword="+keyword,
            success:function(data){
  ...
  $("#super_submit").validate({
    ...
    errorElement : 'div',
      ...
      submitHandler: function() {
        $.ajax({
          url:"<?php echo e(url('/')); ?>/otradd_form",
          type: 'post',
    ...
    $( document ).ready(function() {
      var city= $( "#s_city option:selected" ).text().trim();
       $.ajax({
            type:"GET",
            dataType: "json",
            url:"<?php echo e(url('/getareas')); ?>?City_Id="+city,
            success:function(data){
                if (data) {
                    $("#state").empty();
                    $("#state").append('<option value="">Select Area</option>');
