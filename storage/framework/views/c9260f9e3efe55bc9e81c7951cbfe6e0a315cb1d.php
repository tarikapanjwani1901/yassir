...
<!--     <li <?php echo (Request::is('admin/activity_log') ? 'class="active"' : ''); ?>>
    ...
    <li <?php echo (Request::is('admin/state') || Request::is('admin/cities') || Request::is('admin/cities_search') || Request::is('admin/cities/add') || Request::is('admin/cities/*') 
   ...
   || Request::is('admin/areas') || Request::is('admin/areas_search') || Request::is('admin/areas/add') || Request::is('admin/areas/*')  
     || Request::is('admin/state_search')  || Request::is('admin/state/add') || Request::is('admin/state/*') ? 'class="active"' : ''); ?>>
        ...
        <ul class="sub-menu">
            <li <?php echo (Request::is('admin/state') ? 'class="active" id="active"' : ''); ?>>
                <a href="<?php echo e(URL::to('admin/state')); ?>">
                    <i class="fa fa-angle-double-right"></i>
                   All State
                </a>
            </li>
            <li <?php echo (Request::is('admin/state/add') ? 'class="active" id="active"' : ''); ?>>
                <a href="<?php echo e(URL::to('admin/state/add')); ?>">
                    <i class="fa fa-angle-double-right"></i>
                    Add State
                </a>
            </li>
            
            <li <?php echo (Request::is('admin/cities') ? 'class="active" id="active"' : ''); ?>>
                <a href="<?php echo e(URL::to('admin/cities')); ?>">
                    <i class="fa fa-angle-double-right"></i>
                   All Cities
                </a>
            </li>
            <li <?php echo (Request::is('admin/cities/add') ? 'class="active" id="active"' : ''); ?>>
                <a href="<?php echo e(URL::to('admin/cities/add')); ?>">
                    <i class="fa fa-angle-double-right"></i>
                    Add City
                </a>
            </li>
            ...
            <li <?php echo (Request::is('admin/sub_cities') ? 'class="active" id="active"' : ''); ?>>
                <a href="<?php echo e(URL::to('admin/sub_cities')); ?>">
                    <i class="fa fa-angle-double-right"></i>
                   All Sub Cities
                </a>
            </li>
            <li <?php echo (Request::is('admin/sub_cities/add') ? 'class="active" id="active"' : ''); ?>>
                <a href="<?php echo e(URL::to('admin/sub_cities/add')); ?>">
                    <i class="fa fa-angle-double-right"></i>
                    Add Sub City
                </a>
            </li>
              ...
              <li <?php echo (Request::is('admin/areas') ? 'class="active" id="active"' : ''); ?>>
                <a href="<?php echo e(URL::to('admin/areas')); ?>">
                    <i class="fa fa-angle-double-right"></i>
                   All Areas
                </a>
            </li>
            <li <?php echo (Request::is('admin/areas/add') ? 'class="active" id="active"' : ''); ?>>
    ...
    <li <?php echo (Request::is('admin/vendor_properties') || Request::is('admin/vendor_properties/add') || Request::is('admin/vendor_properties/*') ? 'class="active"' : ''); ?>>
        <a href="#">
            <i class="livicon" data-name="users" data-size="18" data-c="#418BCA" data-hc="#418BCA"
               data-loop="true"></i>
        ...
        <ul class="sub-menu">
            <li <?php echo (Request::is('admin/vendor_properties') ? 'class="active" id="active"' : ''); ?>>
                <a href="<?php echo e(URL::to('admin/vendor_properties')); ?>">
                    <i class="fa fa-angle-double-right"></i>
                    All Property Listing
                </a>
            </li>
            <li <?php echo (Request::is('admin/vendor_properties/add') ? 'class="active" id="active"' : ''); ?>>
                <a href="<?php echo e(URL::to('admin/vendor_properties/add')); ?>">
                    <i class="fa fa-angle-double-right"></i>
