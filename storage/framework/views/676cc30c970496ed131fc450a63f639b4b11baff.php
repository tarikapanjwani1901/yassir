...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/material-design.css')); ?>">
<style>
                           ...
                           <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded" data-upgraded=",MaterialTextfield">
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded" data-upgraded=",MaterialTextfield">                
                                <input type="text" class="mdl-textfield__input only" placeholder="Gstn" id="gstn" name="gst_number">
                                 <div class="text-danger"><?php echo e($errors->first('gst_number')); ?></div>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded" data-upgraded=",MaterialTextfield">                
                                <select class="form-control" name="user_category" id="category">
                                 ...
                                 <div class="text-danger"><?php echo e($errors->first('user_category')); ?></div>
                            </div>
                        </div>  
                        <div class="col-sm-6">
                           <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded" data-upgraded=",MaterialTextfield">
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded" data-upgraded=",MaterialTextfield">                
                                <input type="password" class="mdl-textfield__input" placeholder="Confirm Password" id="conform_password" name="conform_password">
                                 <div class="text-danger"><?php echo e($errors->first('conform_password')); ?></div>
                            </div> 
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded" data-upgraded=",MaterialTextfield">                
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded" data-upgraded=",MaterialTextfield">                
                                <input type="text" class="mdl-textfield__input" placeholder="State" id="state" name="user_state">
                                 <div class="text-danger"><?php echo e($errors->first('user_state')); ?></div>
                            </div>
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded" data-upgraded=",MaterialTextfield" style="display: none;">                
                             ...
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded" data-upgraded=",MaterialTextfield">                
                                <select class="form-control" name="user_sub_cate" id="types">
                                     ...
                                     <div class="text-danger"><?php echo e($errors->first('user_sub_cate')); ?></div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="checkbox">
...
<script src="<?php echo e(asset('public/assets/vendors/bootstrapvalidator/js/bootstrapValidator.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/vendors/iCheck/js/icheck.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/frontend/register_custom.js')); ?>"></script>
<script>
