...
<link type="text/css" href="<?php echo e(asset('public/assets/vendors/bootstrap-multiselect/css/bootstrap-multiselect.css')); ?>" rel="stylesheet" />
<link href="<?php echo e(asset('public/assets/vendors/select2/css/select2.min.css')); ?>" rel="stylesheet" />
...
<link href="<?php echo e(asset('public/assets/css/pages/editor.css')); ?>" rel="stylesheet" type="text/css"/>
<link rel="stylesheet" href="<?php echo e(asset('public/assets/vendors/bootstrap-tagsinput/css/bootstrap-tagsinput.css')); ?>" />
<link href="<?php echo e(asset('public/assets/css/pages/tagsinput.css')); ?>" rel="stylesheet" />

<link href="<?php echo e(asset('public/assets/vendors/bootstrap3-wysihtml5-bower/css/bootstrap3-wysihtml5.min.css')); ?>"  rel="stylesheet" media="screen"/>
<link href="<?php echo e(asset('public/assets/css/pages/editor.css')); ?>" rel="stylesheet" type="text/css"/>
...
<section class="content paddingleft_right15">
  <div class="row">
          ...
          <form method="post" id="addtestimonail" enctype="multipart/form-data">
            <div class="bs-example">
              <div class="stepwizard">
                ...
                <div id="myTabContent" class="tab-content">
                  ...
                  <div class="row setup-content" id="step-1">
                      ...
                      <?php if(Sentinel::inRole('admin')): ?>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin ">
                              <select name="category" id="category" class="form-control" required>
                                ...
                                <?php if(isset($lisitng) && $c->id == $lisitng->l_category): ?>
                        ...
                        <?php elseif(Sentinel::inRole('vendor')): ?>
                        <div class="form-group">
                          <div class="row">
                            <label class="control-label col-sm-12">Select Category:</label>
                            <div class="col-sm-12 select_margin ">
                              <select name="category" id="category" class="form-control" required readonly>
                                ...
                                <option value="<?php echo e($c->id); ?>" selected><?php echo e($c->name); ?></option>
                                <?php else: ?>
                                <option value="<?php echo e($c->id); ?>" disabled=""><?php echo e($c->name); ?></option>
                                <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </div>
                       ...
                       <?php if(Sentinel::inRole('admin')): ?>
                                  ...
                                  <?php $sub = explode(',', $lisitng->l_sub_category); ?>
                                    <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <?php if(in_array($val->id,$sub)): ?>
                                       <option value="<?php echo e($val->id); ?>" selected><?php echo e($val->name); ?></option>
                                      <?php else: ?>
                                        <option value="<?php echo e($val->id); ?>" disabled=""><?php echo e($val->name); ?></option>
                                      <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                              </select>
                            ...
                            <div class="col-sm-12 select_margin ">
                              <select name="sub_cat" id="sub_cat" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php if($val->id == $lisitng->l_sub_category): ?>
                                    <option value="<?php echo e($val->id); ?>" selected><?php echo e($val->name); ?></option>
                                  <?php else: ?>
                                    <option value="<?php echo e($val->id); ?>"><?php echo e($val->name); ?></option>
                                  <?php endif; ?>
                              ...
                              <select name="vendor" id="vendor" class="form-control" required readonly>
                                ...
                                <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php if($v->id == $lisitng->u_id): ?>
                                    <option value="<?php echo e($v->id); ?>" selected="selected"><?php echo e($v->company_name); ?></option>
                                  <?php else: ?>
                                    <option value="<?php echo e($v->id); ?>" disabled=""><?php echo e($v->company_name); ?></option>
                                  <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </div>
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <input type="text" value="<?php echo e($lisitng->url_name); ?>" class="form-control" name="url_name" id="url_name" placeholder="URL Name">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="row">
                            <label class="control-label col-sm-12">URL Name:</label>
                            <div class="col-sm-12 select_margin">
                              <input type="text" value="<?php echo e($lisitng->url_name); ?>" class="form-control" name="url_name" id="url_name" placeholder="URL Name" readonly>
                            </div>
                          </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="form-group" id="expname">
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" name="experience_details" id="experience_details" placeholder="Experience details" value="<?php echo e($lisitng->experience_details); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="form-group" id="agename">
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" name="age_details" id="age_details" placeholder="Age details" value="<?php echo e($lisitng->age_details); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="form-group" id="adname">
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" name="adharnumber_details" id="adharnumber_details" placeholder="Adharnumber details" value="<?php echo e($lisitng->adharnumber_details); ?>">
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <select id="select22" class="form-control select2" name="product_category[]" multiple required>
                                <?php if($lisitng->product_category != ''): ?>
                                  <?php $prcategory = explode(',', $lisitng->product_category); ?>
                                  <?php $__currentLoopData = $proCate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <?php if(in_array($val->cate_id,$prcategory)): ?>
                                          <option value="<?php echo e($val->cate_id); ?>" selected><?php echo e($val->cate_name); ?></option>
                                      <?php else: ?>
                                          <option value="<?php echo e($val->cate_id); ?>"><?php echo e($val->cate_name); ?></option>
                                      <?php endif; ?>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                              </select>
                        ...
                        <?php if(Sentinel::inRole('admin')): ?>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->rera_number); ?>" name="rera_number" id="rera_number" placeholder="RERA Number">
                            </div>
                          </div>
                        </div>
                        <?php elseif(Sentinel::inRole('vendor')): ?>
                        <div class="form-group property_class"  style="display: none;">
                          <div class="row">
                            <label class="control-label col-sm-12">RERA Number:</label>
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->rera_number); ?>" name="rera_number" id="rera_number" placeholder="RERA Number" readonly>
                            </div>
                          </div>
                        </div>
                        <?php endif; ?>
                         ...
                         <div class="form-group property_class"  style="display: none;">
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->rera_link); ?>" name="rera_link" id="rera_link" placeholder="RERA Link">
                            </div>
                          </div>
                        </div>
                         ...
                         <?php if(isset($lisitng->prop) && $lisitng->prop != ''): ?>

                        <?php $__currentLoopData = $lisitng->prop['type']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    $last=end($lisitng->prop['type']);
                        ?>
                          <div class="form-group property_class multiple-form-group col-sm-12"  style="display: none;">
                            <div class="">
                              <div class="row">
                                ...
                                <input type="hidden" class="input-group-select-val" name="price[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="price_perft[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="p_short[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="bedroom[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="bathrooms[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="super_area[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="carpet_area[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="p_status[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="floor[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="transaction_type[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="car_parking[type][]" value="<?php echo e($key); ?>">
                                <input type="hidden" class="input-group-select-val" name="furnishing[type][]" value="<?php echo e($key); ?>">
                              </div>
                             
                            <?php if(Sentinel::inRole('admin')): ?>
                              <?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control price" name="price" id="price" placeholder="Property Price" value="<?php echo e($v->price); ?>">
                                      </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Property Price:</label>
                                        <input type="text" class="form-control price" name="price" id="price" placeholder="Property Price" value="<?php echo e($v->price); ?>" readonly>
                                      </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control price_perft" name="price_perft" id="price_perft" placeholder="Property Price" value="<?php echo e($v->price_perft); ?>">
                                      </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Price/ft2:</label>
                                        <input type="text" class="form-control price_perft" name="price_perft" id="price_perft" placeholder="Property Price" value="<?php echo e($v->price_perft); ?>" readonly>
                                      </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control p_short" name="p_short" id="p_short" placeholder="Ex. 1bhk 515 sq-ft flat" value="<?php echo e($v->short_title); ?>">
                                      </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Short Title:</label>
                                        <input type="text" class="form-control p_short" name="p_short" id="p_short" placeholder="Ex. 1bhk 515 sq-ft flat" value="<?php echo e($v->short_title); ?>" readonly>
                                      </div>
                                  </div>
                                </div>
                              </div>
                          ...
                          <?php $__currentLoopData = $lisitng->prop['bedroom'][$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="form-group property_class multiple-form-group"  style="display: none;">
                                ...
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control bedroom" value="<?php echo e($v); ?>" name="bedroom[<?php echo e($key); ?>][]" id="bedroom" placeholder="Bedrooms">
                                      </div>
                                      <?php
                                        end($value);
                                    if($k != key($value)){
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Bedroom:</label>
                                        <input type="text" class="form-control bedroom" value="<?php echo e($v); ?>" name="bedroom[<?php echo e($key); ?>][]" id="bedroom" placeholder="Bedrooms" readonly>
                                      </div>
                                      <?php
                                        end($value);
                                    if($k != key($value)){
                          ...
                          <?php if(Sentinel::inRole('admin')): ?>
                          <?php $__currentLoopData = $lisitng->prop['bathroom'][$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="form-group property_class multiple-form-group"  style="display: none;">
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control bathrooms" value="<?php echo e($v); ?>" name="bathrooms[<?php echo e($key); ?>][]" id="bathrooms" placeholder="">
                                      </div>
                                      <?php
                                        end($value);
                                    if($k != key($value)){
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Bathrooms:</label>
                                        <input type="text" class="form-control bathrooms" value="<?php echo e($v); ?>" name="bathrooms[<?php echo e($key); ?>][]" id="bathrooms" placeholder="" readonly> 
                                      </div>
                                      <?php
                                        end($value);
                                    if($k != key($value)){
                          ...
                          <?php if(Sentinel::inRole('admin')): ?>
                          <?php $__currentLoopData = $lisitng->prop['super_area'][$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="form-group property_class multiple-form-group"  style="display: none;">
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control namevalue super_area get_value" value="<?php echo e($v); ?>" name="super_area[<?php echo e($key); ?>][]" id="super_area" placeholder="SqrYd">
                                      </div>
                                      <?php
                                        end($value);
                                    if($k != key($value)){
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Built Up Area:</label>
                                        <input type="text" class="form-control namevalue super_area" value="<?php echo e($v); ?>" name="super_area[<?php echo e($key); ?>][]" id="super_area" placeholder="SqrYd" readonly>
                                      </div>
                                      <?php
                                        end($value);
                                    if($k != key($value)){
                          ...
                          <?php if(Sentinel::inRole('admin')): ?>
                          <?php $__currentLoopData = $lisitng->prop['carpet_area'][$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="form-group property_class multiple-form-group"  style="display: none;">
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control namevalue carpet_area" value="<?php echo e($v); ?>" name="carpet_area[<?php echo e($key); ?>][]" id="carpet_area" placeholder="SqrYd">
                                      </div>
                                      <?php
                                        end($value);
                                    if($k != key($value)){
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Carpet Area:</label>
                                        <input type="text" class="form-control namevalue carpet_area" value="<?php echo e($v); ?>" name="carpet_area[<?php echo e($key); ?>][]" id="carpet_area" placeholder="SqrYd" readonly>
                                      </div>
                                      <?php
                                        end($value);
                                    if($k != key($value)){
                                ...
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control p_status" value="<?php echo e($v->status); ?>" name="p_status" id="p_status" placeholder="Property Status">
                                      </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Status:</label>
                                        <input type="text" class="form-control p_status" value="<?php echo e($v->status); ?>" name="p_status" id="p_status" placeholder="Property Status" readonly>
                                      </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control floor" value="<?php echo e($v->floor); ?>" name="floor" id="floor" placeholder="">
                                      </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Floor:</label>
                                        <input type="text" class="form-control floor" value="<?php echo e($v->floor); ?>" name="floor" id="floor" placeholder="" readonly>
                                      </div>
                                  </div>
                                </div>
                              </div>
                          ...
                          <?php if(Sentinel::inRole('admin')): ?>
                          <?php $__currentLoopData = $lisitng->prop['type'][$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="form-group property_class multiple-form-group"  style="display: none;">
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control namevalue transaction_type" value="<?php echo e($v); ?>" name="transaction_type[<?php echo e($key); ?>][]" id="transaction_type" placeholder="">
                                      </div>
                                      <?php
                                        end($value);
                                    if($k != key($value)){
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Transaction type:</label>
                                        <input type="text" class="form-control namevalue transaction_type" value="<?php echo e($v); ?>" name="transaction_type[<?php echo e($key); ?>][]" id="transaction_type" placeholder="" readonly>
                                      </div>
                                  </div>
                                </div>
                              </div>
                                      ...
                                      <div class="form-group">
                                        <label class="control-label property_class">Car parking:</label>
                                          <select name="car_parking" id="car_parking" class="form-control car_parking">
                                            <?php if($v->car_parking==1): ?>
                                                <option value="1" selected>Yes</option>
                                                <option value="0">No</option>
                                            <?php elseif($v->car_parking==0): ?>
                            ...
                            <div class=" propertiesbox" id="furnishing">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Furnishing:</label>
                                          <input type="text" class="form-control furnishing" value="<?php echo e($v->furnishing); ?>" name="furnishing" id="furnishing" placeholder="">
                                        </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Furnishing:</label>
                                          <input type="text" class="form-control furnishing" value="<?php echo e($v->furnishing); ?>" name="furnishing" id="furnishing" placeholder="" readonly>
                                        </div>
                                  </div>
                                </div>
                              </div>
                                  ...
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Possession Date:</label>
                                          <input type="text" class="form-control" value="<?php echo e($v->possession_date); ?>" name="possession_date" id="possession_date" placeholder="" required>
                                        </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Possession Date:</label>
                                          <input type="text" class="form-control" value="<?php echo e($v->possession_date); ?>" name="possession_date" id="possession_date" placeholder="" readonly>
                                        </div>
                                  </div>
                                </div>
                              </div>
                                  ...
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Tower:</label>
                                          <input type="text" class="form-control" value="<?php echo e($v->tower); ?>" name="tower" id="tower" placeholder="">
                                        </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class=" propertiesbox">
                                <div class="row">
                                  <div class="select_margin">
                                      <div class="form-group">
                                        <label class="control-label property_class">Tower:</label>
                                          <input type="text" class="form-control" value="<?php echo e($v->tower); ?>" name="tower" id="tower" placeholder="" readonly>
                                        </div>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div class="form-group property_class" style="display: none;">
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->listed_by); ?>" name="listed_by" id="listed_by" placeholder="">
                            </div>
                          </div>
                        </div>
                        <?php elseif(Sentinel::inRole('vendor')): ?>
                        <div class="form-group property_class" style="display: none;">
                          <div class="row">
                            <label class="control-label col-sm-12">Listed By:</label>
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->listed_by); ?>" name="listed_by" id="listed_by" placeholder="" readonly>
                            </div>
                          </div>
                        </div>
                        <?php endif; ?>
                       ...
                       <div class="form-group property_class" style="display: none;">
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin amen">
                              <textarea name="pro_amenities" id="amenities" rows="5" cols="100"><?php echo e($lisitng->amenities); ?></textarea>
                            </div>
                          </div>
                        </div>
                        <?php elseif(Sentinel::inRole('vendor')): ?>
                       ...
                       <div class="form-group property_class" style="display: none;">
                          <div class="row">
                            <label class="control-label col-sm-12">Multiple Amenities:</label>
                            <div class="col-sm-12 select_margin amen">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->amenities); ?>" name="pro_amenities" id="amenities" placeholder="" readonly>
                            </div>
                          </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="form-group">
                          ...
                          <a target="_blank" href="<?php echo e(url('/')); ?>/public/images/brochure/<?php echo e($lisitng->vl_id); ?>/<?php echo e($lisitng->l_brochure); ?>"><?php echo e($lisitng->l_brochure); ?></a> 
                          ...
                          <?php
                            ...
                            foreach ($files as $key => $value) { ?>
                              <div id="d" class="productimg">
                                <img src="/public/images/extravideo/<?php echo e($value); ?>/<?php echo e($lisitng->l_extravideo); ?>" id="img_<?php echo e($key); ?>" style="display: none;">

                               <a href="javascript:void(0);" class="cross"> <span class="glyphicon glyphicon-remove extravideo_remove"  id="<?php echo e($key); ?>"></span>
                               </a>
                             </div>
                            <?php } }
                        ?>
                      ...
                      <div class="col-md-6 paddleft0">
                        <div class="form-group" id="pname">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->l_title); ?>" name="project_name" id="project_name" placeholder="Project Name" required>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->l_location); ?>" name="address" id="address" placeholder="Address" required>
                            </div>
                          </div>
                        </div>
                        <div class="form-group" id="locname">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" class="form-control" id="near_by" value="<?php echo e($lisitng->l_nearby); ?>" name="near_by" placeholder="Near By Location" required>
                            </div>
                          </div>
                        </div>
                         <div class="form-group">
                          ...
                          <select id="l_city" name="city" class="form-control">
                           <option value="">City</option>
                              ...
                              <?php $__currentLoopData = $city_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                              <?php if(isset($lisitng->city) && $d->City_Name == ($lisitng->city)): ?>
                              <?php echo "hii"; ?>
                                    <option value="<?php echo e($d->City_Name); ?>" selected='selected'><?php echo e($d->City_Name); ?></option>
                                     <?php else: ?>
                        ...
                        <div class="form-group" id="zipname">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->Zip_Code); ?>" name="Zip_Code" id="Zip_Code" placeholder="Zip Code" required >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group" id="ptagname">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" name="pro_tags" id="pro_tags" value="<?php echo e($lisitng->l_key_area); ?>" data-role="tagsinput" required/>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 paddleft0">
                        <div class="form-group" id="pname">
                          <div class="row">
                            <label class="control-label col-sm-12" for="project_name">Project Name:</label>
                            <div class="col-sm-12">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->l_title); ?>" name="project_name" id="project_name" placeholder="Project Name" required readonly>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" id="locname">
                          <div class="row">
                            <label class="control-label col-sm-12" for="near_by">Location:</label>
                            <div class="col-sm-12">
                              <input type="text" class="form-control" id="near_by" value="<?php echo e($lisitng->l_nearby); ?>" name="near_by" placeholder="Near By Location" required readonly>
                            </div>
                          </div>
                        </div>
                         <div class="form-group">
                          ...
                          <select id="l_city" name="city" class="form-control" readonly>
                           <option value="" disabled="">City</option>
                              ...
                              <?php if(isset($lisitng->city) && $d->City_Name == ($lisitng->city)): ?>
                                    ...
                                    <option value="<?php echo e($d->City_Name); ?>" selected='selected'><?php echo e($d->City_Name); ?></option>
                                     <?php else: ?>
                                     <option value="<?php echo e($d->City_Name); ?>" disabled=""><?php echo e($d->City_Name); ?></option>
                                     <?php endif; ?>
                        ...
                        <div class="form-group" id="zipname">
                          <div class="row">
                            <label class="control-label col-sm-12" for="Zip_Code">Zip Code:</label>
                            <div class="col-sm-12">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->Zip_Code); ?>" name="Zip_Code" id="Zip_Code" placeholder="Zip Code" required readonly>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group" id="ptagname">
                          <div class="row">
                            <label class="control-label col-sm-12" for="tags">Project Tags:</label>
                            <div class="col-sm-12">
                              <input type="text" name="pro_tags" id="pro_tags" value="<?php echo e($lisitng->l_key_area); ?>" data-role="tagsinput" required readonly />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group" id="abname">
                          ...
                          <textarea class="form-control resize_vertical" name="about_project" id="about_project" rows="3" required><?php echo e($lisitng->l_description); ?></textarea>
                      </div>
                      </div>
                      <?php elseif(Sentinel::inRole('vendor')): ?>
                      <div class="col-sm-12">
                      <div class="form-group" id="abname">
                          <label for="about_project">About Project</label>
                          <textarea class="form-control resize_vertical" name="about_project" id="about_project" rows="3" required readonly><?php echo e($lisitng->l_description); ?></textarea>
                      </div>
                      </div>
                      <?php endif; ?>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" class="form-control" id="first_Name" name="first_Name" value="<?php echo e($lisitng->first_name); ?>" placeholder="First Name" required>
                            </div>
                          </div>
                        </div>
                        <?php elseif(Sentinel::inRole('vendor')): ?>
                ...
                <?php if($lisitng->l_category == 4 || $lisitng->l_category == 3 || $lisitng->l_category == 2): ?>
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" class="form-control" value="<?php echo e($lisitng->last_name); ?>" name="last_Name" id="last_Name" placeholder="Last Name" required>
                            </div>
                          </div>
                        </div>
                         <?php if($lisitng->l_category == 4 || $lisitng->l_category == 3 || $lisitng->l_category == 2): ?>
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="email" class="form-control" value="<?php echo e($lisitng->email); ?>" name="email" id="email" placeholder="Email" required>
                            </div>
                          </div>
                        </div>
                        <?php elseif(Sentinel::inRole('vendor')): ?>
                        <div class="form-group">
                          <div class="row">
                            <label class="control-label col-sm-12" for="email">Email:</label>
                            <div class="col-sm-12">
                              <input type="email" class="form-control" value="<?php echo e($lisitng->email); ?>" name="email" id="email" placeholder="Email" required readonly>
                            </div>
                          </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" name="phone_Number" value="<?php echo e($lisitng->Phone); ?>" class="form-control number" id="phone_Number" placeholder="Phone Number" required>
                            </div>
                          </div>
                        </div>
                        <?php elseif(Sentinel::inRole('vendor')): ?>
                        <div class="form-group">
                          <div class="row">
                            <label class="control-label col-sm-12" for="phone_Number">Phone:</label>
                            <div class="col-sm-12">
                              <input type="text" name="phone_Number" value="<?php echo e($lisitng->Phone); ?>" class="form-control number" id="phone_Number" placeholder="Phone Number" required readonly>
                            </div>
                          </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="form-group" id="webname">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" name="website" value="<?php echo e($lisitng->website); ?>" class="form-control" id="website" placeholder="Website">
                            </div>
                          </div>
                        </div>
                        <div class="form-group" id="fbname">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" name="face_book" value="<?php echo e($lisitng->facebook); ?>" class="form-control" id="face_book" placeholder="FB Link">
                            </div>
                          </div>
                        </div>
                        <div class="form-group" id="yuname">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" name="you_tube" value="<?php echo e($lisitng->youtube); ?>" class="form-control" id="you_tube" placeholder="Your Tube">
                            </div>
                          </div>
                        </div>
                        <div class="form-group" id="viname">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" name="l_video_link" value="<?php echo e($lisitng->l_video_link); ?>" class="form-control" id="l_video_link" placeholder="Promo Video Link">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 paddleft0">
                          <div class="form-group">
                              <label for="area" class="control-label col-sm-12">Achievements</label>
                               <div class="col-sm-12"> <textarea class="form-control resize_vertical" name="achievements" id="achievements" rows="3"><?php echo e($lisitng->achievements); ?></textarea>
                          </div> </div>

                          <div class="form-group" id="ppname">
                              <label for="area" class="control-label col-sm-12">Past Projects</label>
                               <div class="col-sm-12"> <textarea class="form-control resize_vertical" name="past_project" id="past_project" rows="3"><?php echo e($lisitng->past_projects); ?></textarea>
                          </div> </div>

                          <div class="form-group" id="cpname">
                              <label for="area" class="control-label col-sm-12">Current Project</label>
                              <div class="col-sm-12">  <textarea class="form-control resize_vertical" name="current_project" id="current_project" rows="3"><?php echo e($lisitng->current_project); ?></textarea>
                          </div> </div>
                          <div class="form-group">
                            <label for="area" class="control-label col-sm-12">Owner Logo</label>
                              ...
                              <?php if(!$lisitng->logo == ""): ?>
                              <img src="<?php echo e(url('/')); ?>/public/images/logo/<?php echo e($lisitng->vl_id); ?>/<?php echo e($lisitng->logo); ?>"> 
                              <?php else: ?>
                                <img src="<?php echo e(url('/')); ?>/public/images/noimage.png" width="100px;"> 
                                <?php endif; ?>
                              <br><br>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label for="area" class="control-label col-sm-12">Achievements</label>
                               <div class="col-sm-12"> <textarea class="form-control resize_vertical" name="achievements" id="achievements" rows="3" readonly><?php echo e($lisitng->achievements); ?></textarea>
                          </div> </div>

                          <div class="form-group" id="ppname">
                              <label for="area" class="control-label col-sm-12">Past Projects</label>
                               <div class="col-sm-12"> <textarea class="form-control resize_vertical" name="past_project" id="past_project" rows="3" readonly><?php echo e($lisitng->past_projects); ?></textarea>
                          </div> </div>

                          <div class="form-group" id="cpname">
                              <label for="area" class="control-label col-sm-12">Current Project</label>
                              <div class="col-sm-12">  <textarea class="form-control resize_vertical" name="current_project" id="current_project" rows="3" readonly><?php echo e($lisitng->current_project); ?></textarea>
                          </div> </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group" id="workhrname">
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <input type="text" class="form-control" name="working_time" value="<?php echo e($lisitng->working_time); ?>" id="working_time" placeholder="Working Time">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group" id="workhrname">
                          <div class="row">
                            <label class="control-label col-sm-12" for="website">Working Hrs:</label>
                            <div class="col-sm-12">
                              <input type="text" class="form-control" name="working_time" value="<?php echo e($lisitng->working_time); ?>" id="working_time" placeholder="Working Time" readonly>
                            </div>
                          </div>
                        </div>
                      </div>
                                  ...
                                  <?php
                                      ...
                                      foreach ($files as $key => $value) { ?>
                                        <div id="d_<?php echo e($key); ?>" class="productimg">
                                          <img src="/public/images/<?php echo e($lisitng->vl_id); ?>/pics/<?php echo e($value); ?>" id="img_<?php echo e($key); ?>" >

                                         <a href="#" class="cross"> <span class="glyphicon glyphicon-remove img_remove"  id="<?php echo e($key); ?>"></span>
                                         </a>
                                       </div>
                                      <?php } }
                                  ?>
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-12 pad-top20 galleryphotos">
                                  ...
                                  <?php
                                      ...
                                      $img = '';
                                      foreach ($files as $key => $value) { ?>
                                        <div id="b_<?php echo e($key); ?>" class="productimg">
                                          <img src="/public/images/<?php echo e($lisitng->vl_id); ?>/banner/<?php echo e($value); ?>" id="bimg_<?php echo e($key); ?>">

                                         <a href="#" class="cross"> <span class="glyphicon glyphicon-remove b_remove"  id="<?php echo e($key); ?>"></span>
                                         </a>
                                       </div>
                                      <?php } }
                                  ?>
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-12 pad-top20 galleryphotos">
                                  <?php
                                      ...
                                      $img = '';
                                      foreach ($files as $key => $value) { ?>
                                        <div id="f_<?php echo e($key); ?>" class="productimg">
                                          <img src="/public/images/<?php echo e($lisitng->vl_id); ?>/featured_image/<?php echo e($value); ?>" id="fimg_<?php echo e($key); ?>">

                                         <a href="#" class="cross"> <span class="glyphicon glyphicon-remove f_remove"  id="<?php echo e($key); ?>"></span>
                                         </a>
                                       </div>
                                      <?php } }
                                  ?>
                    ...
                    <input type="text" class="form-control namevalue price" name="shop_price" id="shop_price" placeholder="Property Price" value="<?php echo e($lisitng->shop_price); ?>">
                    </div>
                    </div>
                    </div>
                    </div>
                    ...
                    <input type="text" class="form-control namevalue super_area" name="shop_area" id="shop_area" placeholder="" value="<?php echo e($lisitng->shop_area); ?>">
                    </div>
                    </div>
                    </div>
                    </div>
                    ...
                    <input type="text" class="form-control namevalue bathrooms" name="shop_washroom" id="shop_washroom" placeholder=""  value="<?php echo e($lisitng->shop_washroom); ?>">
                    </div>
                    </div>
                    </div>
                    </div>
                    ...
                    <input type="text" class="form-control namevalue floor" name="shop_floor" id="shop_floor" placeholder="" value="<?php echo e($lisitng->shop_floor); ?>">
                    </div>
                    </div>
                    </div>
                    </div>
                    ...
                    <select name="shop_car_parking" id="shop_car_parking" class="form-control namevalue car_parking"  value="<?php echo e($lisitng->shop_car_parking); ?>"> 
                    <option value="1">Yes</option>
                    <option value="0">No</option>
                    </select>
                    </div>
    ...
    <input type="hidden" value="<?php echo e($lisitng->vl_id); ?>" name="vl_id" id="vl_id">
...
<?php $__env->startSection('footer_scripts'); ?>
  ...
  <script language="javascript" type="text/javascript" src="<?php echo e(asset('public/assets/vendors/bootstrap-multiselect/js/bootstrap-multiselect.js')); ?>" ></script>
  <script src="<?php echo e(asset('public/assets/vendors/tinymce/tinymce.min.js')); ?>" type="text/javascript"></script>
  <script language="javascript" type="text/javascript" src="<?php echo e(asset('public/assets/vendors/select2/js/select2.js')); ?>"></script>
  <script language="javascript" type="text/javascript" src="<?php echo e(asset('public/assets/vendors/sifter/sifter.js')); ?>"></script>
  <script language="javascript" type="text/javascript" src="<?php echo e(asset('public/assets/vendors/microplugin/microplugin.js')); ?>"></script>
  <script language="javascript" type="text/javascript" src="<?php echo e(asset('public/assets/vendors/selectize/js/selectize.min.js')); ?>"></script>
  <script language="javascript" type="text/javascript" src="<?php echo e(asset('public/assets/js/pages/custom_elements.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('public/assets/vendors/tinymce/tinymce.min.js')); ?>" type="text/javascript"></script>
  <script  src="<?php echo e(asset('public/assets/vendors/ckeditor/js/ckeditor.js')); ?>"  type="text/javascript"></script>
  <script  src="<?php echo e(asset('public/assets/vendors/ckeditor/js/jquery.js')); ?>"  type="text/javascript" ></script>
  <script  src="<?php echo e(asset('public/assets/vendors/ckeditor/js/config.js')); ?>"  type="text/javascript"></script>
  <script src="<?php echo e(asset('public/assets/js/pages/editor.js')); ?>" type="text/javascript"></script>
  ...
  <script type="text/javascript">
    ...
    function()
    {
      ...
      jQuery("#vendor").on('change', function() {
        ...
        if (cat == '4' && vendor != '') {
            $.ajax({
                type: "GET",
                dataType: "json",
                url: "<?php echo e(url('/admin/vendorlisting/getProductCategory')); ?>?vendor=" + vendor + "&category=" + cat,
                success: function(data) {
                    if (data) {
                        $("#pro_cate").css('display','none');
      ...
      $('#url_name').on('blur',function(){
        ...
        $.ajax({
              type:"POST",
              url:"<?php echo e(url('/admin/vendorlisting/url_name')); ?>",
...
<script type="text/javascript">
 $("#ameniti_id").change(function(){
   ...
   var src = "<?php echo e(url('/')); ?>/public/images/amenities/"+ b +".png";
...
<script>
  ...
  var a = "<?php echo e(url('/')); ?>/admin/vendorlisting?category="+d;
...
$('input.tower').prop('required',false);
            ...
            $.ajax({
                   url: "<?php echo e(url('/')); ?>/admin/vendorlisting/edit/<?php echo e($lisitng->vl_id); ?>",
             type: "POST",
...
//video remove
 ...
 $('.brand_remove').click(function(){
  //alert('yes');
      ...
      $.ajax({
        type:"POST",
        url:"<?php echo e(url('/')); ?>/<?php echo e('admin/vendorlisting/del_extravideo'); ?>",
        data:{file:file},
        dataType: "json",
        success: function(data){
          $("#imgrmv"+id).hide();
 ...
 $('.extravideo_remove').click(
    function()
    {
      ...
      $.ajax({
        type:"POST",
        url:"<?php echo e('/admin/vendorlisting/del_extravideo'); ?>",
        data:{file:file},
        dataType: "json",
