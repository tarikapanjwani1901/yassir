...
<style type="text/css">
  /*  .select2.select2-container.select2-container--default.select2-container--open.select2-container--above{width: 20% !important;}
    .select2-dropdown.select2-dropdown--below{width: 190px !important;position: relative !important;left: 0px !important;z-index: 999999 !important;}
    .dropdown-menu{background-color: #69758aab !important;}
    .dropdown-menu>li>a{color: #fff;font-weight:bold;}
    .dropdown-menu>li>a:focus, .dropdown-menu>li>a:hover{    background-color: #bb1f3d;}
    ...
    .select2-container--open .select2-dropdown{background: #69758aab !important;}
    .select2-container--default .select2-results__option--highlighted[aria-selected]{background-color: #bb1f3d !important;}*/
    body .select2-dropdown.select2-dropdown--below{width: 164px !important;position: relative !important;left: 0px !important;z-index: 999999 !important;}
    .dropdown-menu{background-color: #69758aab !important;}
    .dropdown-menu>li>a{color: #fff;font-weight:bold;}
    .dropdown-menu>li>a:focus, .dropdown-menu>li>a:hover{    background-color: #bb1f3d;}
    .dropdown-menu  li{color:#fff !important;} 
    ...
    .select2-container--open .select2-dropdown{background: #69758aab !important;}
    .select2-container--default .select2-results__option--highlighted[aria-selected]{background-color: #bb1f3d !important;}
     #countryList .dropdown-menu{display: block;width: 72% !important;position: relative !important;}
     #countryList{position: relative;left: 18%;}
     .sticky-tab #countryList{top: -17px;}
    .bannertext.sticky-tab #countryList .dropdown-menu{left: 14%;width: 43% !important;}
   </style>
<!-- <link href="https://fonts.googleapis.com/css?family=Work+Sans:700" rel="stylesheet"> -->
      <link rel="stylesheet" href="<?php echo e(asset('public/css/home_blade.css')); ?>">
<!-- banner section-->
    <div class="banner-row">
                 ...
                 <?php
                    ...
                    if (is_dir($directory)) {
						...
						foreach ($files as $key => $value) { ?>
						    <li style="background-image:url(public/images/home_galery/<?php echo e($value); ?>)"></li>
						  <?php }
					}
                ?>
            </ul>
        ...
        <div class="bannertext">
            ...
            <div>  <!--<h1>We will help you to find all</h1>
            <span class="hd1">Want to buy or refurbish your own property? Or looking for potential buyers for your house or office? Your search ends here<br></span> --> </div>
            <div class="searchbox  s-box">


                <form action="listing" method="get" id="home_search" autocomplete="off">
                <button type="" class=propertybtn" id="" style="float: left !important; border-radius: 0px !important; width: 15%;right: 0px !important;">
                    <a href="listing?s_key=&s_city=&s_category=1&s_type=" style="color:white;" >Properties</a>
                </button>
                      <input type="text" name="s_key" id="s_key" class="gcse-search" onkeyup="getPredefineSelection()" placeholder="Type your requirements">
                    <button type="submit" id="submit_search"><i class="fa fa-search"></i></button>
                </form>
                <?php 
                        
                        include(app_path().'/../public/'.'BrowserDetection.php');
                        include(app_path().'/../public/'.'Mobile_Detect.php');
                        ...
                        if($detect->isMobile()){ ?>
                           <input type="hidden" name="device" id="device" value="<?php  echo $type='Mobile'; ?>">
    ...
    <!--banner section end-->
    <!-- category row-->
    <div class="category-row mg1" style="display:none;">
        <div class="container">
            ...
            <a style="display:none;" class="category-box" href="listing?s_key=&s_city=&s_category=2&s_type=">
            <!-- <a class="category-box" href="detail/5"> -->
                <img src="public/images/homepage_icon_img/consultancy.png" alt="Consultancy">
                <span>Consultancy</span>
            </a>
            <a style="display:none;" class="category-box" href="listing?s_key=&s_city=&s_category=3&s_type=">
            <!-- <a class="category-box" href="detail/7"> -->
                <img src="public/images/homepage_icon_img/contractors.png" alt="Contractor">
                <span>Contractor</span>
            </a>
            <a style="display:none;" class="category-box" href="listing?s_key=&s_city=&s_category=4&s_type=">
            <!-- <a class="category-box" href="detail/9"> -->
                <img src="public/images/homepage_icon_img/material.png" alt="Material">
                <span>Material</span>
            </a>

            <a style="display:none;" class="category-box" href="listing?s_key=&s_city=&s_category=5&s_type=">
            <!-- <a class="category-box" href="detail/9"> -->
                        ...
                        <figure>
                           ...
                           if(is_dir($directory) && count(glob("$directory/*")) !== 0){ ?>
                                    <div class="property-bg">
                                        <img class="popular_image" src="<?php echo e(url('/')); ?>/public/images/<?php echo e($listings->vl_id); ?>/featured_image/<?php echo e($value); ?>" alt="featured_image">
                                    </div>
                            <?php  } else { ?>
                                    <div class="property-bg"    >
                                        <img class="popular_image" src="<?php echo e(url('/')); ?>/public/images/<?php echo e($listings->vl_id); ?>/featured_image/<?php echo e($value); ?>" alt="featured_image">
                            ...
                            <?php  }  ?>
                               <?php if(isset($listings->url_name) && $listings->url_name != ""): ?>
                                <?php
                                    if ($check == '1') { ?>
                                        <div class="btn"><a href="detail/<?php echo e($listings->url_name); ?>" class="onclick" ><?php echo e($listings->l_title); ?></a></div>
                                    <?php } else { ?>
                                            <div class="btn"><a href="#" class="onclick" data-id="detail/<?php echo e($listings->url_name); ?>" data-toggle="modal" data-target="#myOTP"><?php echo e($listings->l_title); ?></a></div>
                                    <?php }
                                ?>
                                <?php else: ?>
                                <?php
                                    if ($check == '1') { ?>
                                        <div class="btn"><a href="detail/<?php echo e($listings->vl_id); ?>" class="onclick" ><?php echo e($listings->l_title); ?></a></div>
                                    <?php } else { ?>
                                            <div class="btn"><a href="#" class="onclick" data-id="detail/<?php echo e($listings->vl_id); ?>" data-toggle="modal" data-target="#myOTP"><?php echo e($listings->l_title); ?></a></div>
                                    <?php }
                                ?>
                                <?php endif; ?>

                            <div class="like" onclick="saveListing('listing_<?php echo e($listings->vl_id); ?>')">
                                <i class="fa fa-heart"></i>
                            </div>
                        </figure>
                        <div class="content">
                            
                            <p><?php echo \Illuminate\Support\Str::words($listings->l_description, 10,'....'); ?></p>
                            <div class="rating">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <?php if($i <= $listings->l_review): ?>
                            ...
                            <div class="address">
                                <i class="fa fa-map-marker"></i> <?php echo e($listings->l_nearby); ?>
                    ...
                    <li>
                        <div class="">
                            <a class="feture-box" href="listing?s_key=&s_city=&s_category=1&s_type=<?php echo $value->id?>">
                                ...
                                <div class="featureimg" style="background-image:url(public/images/category/1/<?php echo e($value->image); ?>);"></div>
                                <?php } else {?>
  ...
  <div class="col-sm-3">
    <div class="property-adv feture-box">
                    ...
                    <video poster="public/images/video_logo.jpg" controls muted loop style=" width: 100%; height: 142px; background-color: black;">
                        <source src="<?php echo e(url('/')); ?>/public/images/home_add/<?php echo e($value); ?>" type="video/mp4" /> 
                    </video>
                    <?php } ?>   
        <div class="content">
            <h3>&nbsp;</h3>
   ...
   <!-- -->
    <div class="commonttl-subttl" style="display:none;">
                <h2>Consultancy</h2>
            </div>
   ...
   <div class="col-sm-12">
       <div class="flexslider2 flex_consultancy carousel">
                ...
                <?php foreach ($category_consultancy as $key => $value) { ?>
                    <li>
                        <div class="">
                            ...
                            <?php if(isset($value->image)) { ?>
                                <div class="featureimg" style="background-image:url(public/images/category/2/<?php echo e($value->image); ?>);"></div>
                                <?php } else {?>
                                <div class="featureimg" style="background-image:url(public/images/noimage.png);" width="100%"></div>
                                <?php } ?>
                                <div class="content">
           ...
           <div style="display:none;" class="commonttl-subttl">
                <h2>Contractor</h2>
            </div>
   <div class="row" style="display:none;">
   <div class="col-sm-12">
                ...
                <?php foreach ($category_contractor as $key => $value) { ?>
                    <li>
                        <div class="">
                            ...
                            <?php if(isset($value->image)) { ?>
                                <div class="featureimg" style="background-image:url(public/images/category/3/<?php echo e($value->image); ?>);"></div>
                                <?php } else {?>
                                <div class="featureimg" style="background-image:url(public/images/noimage.png);" width="100%"></div>
                                <?php } ?>
                                <div class="content">
                            ...
                            <?php foreach ($category_material as $key => $value) { ?>
                                <li>
                                    <div class="">
                                        ...
                                        <?php if(isset($value->image)) { ?>
                                            <div class="featureimg" style="background-image:url(public/images/category/4/<?php echo e($value->image); ?>);"></div>
                                            <?php } else {?>
                                            <div class="featureimg" style="background-image:url(public/images/noimage.png);" width="100%"></div>
                                            <?php } ?>
                                            <div class="content">
                            ...
                            <?php foreach ($category_skill_labour as $key => $value) { ?>
                                <li>
                                    <div class="">
                                        ...
                                        <?php if(isset($value->image)) { ?>
                                            <div class="featureimg" style="background-image:url(public/images/category/5/<?php echo e($value->image); ?>);"></div>
                                            <?php } else {?>
                                            <div class="featureimg" style="background-image:url(public/images/noimage.png);" width="100%"></div>
                                            <?php } ?>
                                            <div class="content">
                    ...
                    foreach ($files as $key => $value) { ?>
                        <li>
                            <div class="">
                                ...
                                <img src="<?php echo e(url('/')); ?>/public/images/brand/<?php echo e($value); ?>" alt="brand">    
        ...
        <div class="container">   
            <div class="row">
                <div class="col-sm-4 text-center">
                    <h3><?php echo e($visitor_count); ?></h3>
                    <span>new visitor</span>
                </div>
                <div class="col-sm-4 text-center">
                    <h3><?php echo e($happy_cust); ?></h3>
                    <span>Happy customers</span>
                </div>            
                <div class="col-sm-4 text-center">
                    <h3><?php echo e($vendor_count); ?></h3>
            ...
            <ul class="slides">
                ...
                <li class="text-center">
                        <div class="testicontent">
                            ...
                            <p><?php echo e($t->t_quote); ?></p>
                        </div>
                    <div class="reviewer">
                        <img src="public/assets/images/testimonial-down-arrow.png" class="arrow" alt="Review">
                        <figure class="testimonial-figure">
                            <img src="public/images/testimonial/<?php echo e($t->t_id); ?>/<?php echo e($t->t_image); ?>" alt="Review">
                        </figure>
                        <h5><?php echo e($t->t_name); ?></h5>
                        <span><?php echo e($t->t_company); ?></span>
                    </div>
                </li>
...
<script src="<?php echo e(asset('public/assets/js/select2_b86534ec160eaa35eabe3003543e50eb.js')); ?>" defer></script>
<script>
    function msg() {
...
$('#home_search').on("submit",function()
    {
       var search_keyword = $('#s_key').val();  
       var device = $('#device').val();
       var ios = $('#ios').val();
       var ip = $('#ip').val();
     
       $.ajax({
            url:"<?php echo e(url('/visitors_search_data')); ?>",
            type: "POST",
            data: {
                   "_token": "<?php echo e(csrf_token()); ?>",
                     "search_keyword": search_keyword,"device": device,"ios": ios,"ip": ip
            },        
