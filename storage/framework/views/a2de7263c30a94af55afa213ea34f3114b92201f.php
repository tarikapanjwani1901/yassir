...
<link href="<?php echo e(asset('public/assets/css/pages/editor.css')); ?>" rel="stylesheet" type="text/css"/>
<link href="<?php echo e(asset('resources/views/admin/amenities/flaticon.css')); ?>" rel="stylesheet" type="text/css"/>
            ...
            <div class="bs-example">
              <div class="stepwizard">
                <div class="stepwizard-row setup-panel">
                  ...
                  <div class="stepwizard-step">
                  <a href="#step-5" type="button" class="btn btn-default btn-circle si" disabled>Shop Info</a>
                  </div>
                </div>
                  ...
                  <div class="tab-pane fade active in" id="listing">
                    <div class="row setup-content" id="step-1">
                      <div class="col-md-6 paddleft0">
                        ...
                        <?php else: ?>
                          <input type="hidden" name="category" id="category" value="<?php echo e(Sentinel::getUser()->user_category); ?>">
                        <?php endif; ?>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              ...
                              <select name="sub[]" id="select57" class="form-control select2" required multiple>
                                ...
                                <?php if(isset($type)): ?>
                                  <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($c->id); ?>"><?php echo e($c->name); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                              </select>
                        ...
                        <?php else: ?>
                          <input type="hidden" name="vendor" id="vendor" value="<?php echo e(Sentinel::getUser()->id); ?>">
                        <?php endif; ?>
                        ...
                        <div class="form-group" id="expname">
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" name="experience_details" id="experience_details" placeholder="Experience details">
                            </div>
                          </div>
                        </div>
                        <div class="form-group" id="agename">
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" name="age_details" id="age_details" placeholder="Age details">
                            </div>
                          </div>
                        </div>
                        <div class="form-group" id="adname">
                          <div class="row">
                            ...
                            <div class="col-sm-12 select_margin">
                              <input type="text" class="form-control" name="adharnumber_details" id="adharnumber_details" placeholder="Adharnumber details">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <select id="l_city" name="city" class="form-control">
                           <option value="">City</option>
                              <?php $__currentLoopData = $city_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $citys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  
                                  <option value="<?php echo e($citys->City_Name); ?>"><?php echo e($citys->City_Name); ?></option>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                <div class="row">
                                  ...
                                  <div class="form-group property_class multiple-form-group hide_section"  style="display: none;">
                                    <div class=" propertiesbox">
                                      <div class="row">
                                        <div class="select_margin">
                                          <div class="form-group">
...
<script type="text/javascript">
  ...
  var str1 = $('#icon_id').val();
  var str2 =  $('#ameniti_id').val();
  var str3 = str1 + str2;
 $('#final').val(str3);
});
});
