                        ...
                        <tbody>
                            ...
                            @if ($result[0]->Phone != '')
                                <tr>
                                    ...
                                    <td><a href="tel:{{ $result[0]->Phone }}">{{ $result[0]->Phone }}</a></td>
                                </tr>
                            @endif
                          <tr>
                            ...
                            @if($result[0]->youtube != '' || $result[0]->facebook != '')
                            <tr>
                                <td colspan="2" class="socialicon">
                                    @if(isset($result[0]->facebook) && $result[0]->facebook != '')
                                        <a href="https://{{ $result[0]->facebook }}" target="_blank"><i class="fa fa-facebook-square"></i> </a>
                                    @endif

                                    @if(isset($result[0]->youtube) && $result[0]->youtube != '')
                                        <a href="{{ $result[0]->youtube }}" target="_blank"><i class="fa fa-youtube-square"></i> </a>
                                    @endif
                                </td>
                            </tr>
                            @endif
            ...
            <!--Creates the popup content-->
             <div class="popup-content">
                ...
                <form id="otp_form" method="post" class="formdesign1">
                   ...
                   </div><div class="fromgroup"> <input type="hidden" name="listing_id" value="{{ $result[0]->vl_id }}" id="listing_id">
                  </div> <div class="fromgroup"> <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        </div></div>
                ...
                <div class="map-address sidebox">
                    <div class="hostbanner">
                        <div class="hostperson">
                            @if(!$result[0]->logo == "")
                            <img src="../public/images/logo/{{$result[0]->vl_id}}/{{ $result[0]->logo }}" alt="logo">
                            @else
                             <img src="{{url('/')}}/public/images/noimage.png" width="100px;" alt="noimage"> 
                             @endif
                        </div>
                    </div>
                    <table>
                            ...
                            @if($result[0]->web_site)
                                <tr>
                                    ...
                                    @if(strpos($result[0]->web_site, "http://"))
                                        <td><a href="{{ $result[0]->web_site }}" target="_blank">{{ $result[0]->web_site }}</a></td>
                                    @else
                                        <td><a href="http://{{ $result[0]->web_site }}" target="_blank">{{ $result[0]->web_site }}</a></td>
                                    @endif
                                </tr>
                            @endif
                        </tbody>
  ...
  <div class="fm">
    <div class="book-form sidebox bvisit">
        <form class="formdesign1" method="post" id="bookvisit_info">
                        ...
                        <input type="hidden" name="uemail" id="uemail" value="{{ $result[0]->email }}">
                        <input type="hidden" name="u_id" id="u_id" value="{{ $result[0]->u_id }}">
