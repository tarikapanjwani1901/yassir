...
@section('header_styles')
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/frontend/panel.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/frontend/features.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/frontend/timeline.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendors/switchery/css/switchery.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/vendors/bootstrap-switch/css/bootstrap-switch.css') }}">
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/js/frontend/advfeatures.js') }}"></script>
    <!--page level js ends-->
