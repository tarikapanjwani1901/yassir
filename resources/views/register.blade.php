    ...
    <div class="row">
        <div class="box animation flipInX">
            ...
            <form action="{{ route('register') }}" method="POST" id="reg_form">
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="subscribed" >  I accept <a href="{{url('/terms_of_use')}}"> Terms and Conditions</a>
                    </label>
                </div>
...
<script type="text/javascript" src="{{ asset('public/assets/js/frontend/register_custom.js') }}"></script>
<!--global js end-->
</body>
</html>
