...
.loginPage .loginBox figure{ padding:15px; width:125px;height:125px;background:#fff;border-radius:50%;display: inline-flex; }
...
.fp{margin: 10px 0px;display: inline-block;}
.loginPage .loginForm .btn {margin-bottom: 10px;}
.loginPage .loginBox a.forgotPassword {float: none;margin: 10px  0px;}
#frgt {text-align: left;}
.loginPage .loginForm .btn {width: 100%;}
</style>
<body>
<div class="container">
    <div class="row">
        <div class="loginPage">
            <div class="loginBox">
                ...
                <div class="loginForm">
                    <form method="post" id="frgt" action="{{ route('forgot-password') }}" autocomplete="off">
                     <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded" data-upgraded=",MaterialTextfield">
                        <input type="text" class="mdl-textfield__input" placeholder="Email" id="username" name="email">
                      </div>
                      <div class="clearfix">
                        <input type="submit" class="btn btn-danger submitBtn" name="submit" value="Reset Your Password">
                        </div> 
                        <span class="fp">Back to login page?</span><a class="forgotPassword" href="{{url('/')}}/login">Click here</a>
                    </form>
                </div>
            </div>
        </div>
