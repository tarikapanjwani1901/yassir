...
@section('header_styles')
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/frontend/aboutus.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendors/animate/animate.min.css') }}"/>
    <link rel="stylesheet" href="{{ asset('assets/vendors/owl_carousel/css/owl.carousel.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendors/owl_carousel/css/owl.theme.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendors/devicon/devicon.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendors/devicon/devicon-colors.css') }}">
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/js/frontend/carousel.js') }}"></script>
    <script src="{{ asset('assets/js/frontend/aboutus.js') }}"></script>
    <!--page level js ends-->
@stop
