    ...
    <div class="row">
        <div class="loginPage">
            <div class="loginBox">
                ...
                @if (Session::get('login_mobile'))
                <div class="loginForm">
                	 <form method="post" id="login_form" action="{{ route('otpSubmit') }}" autocomplete="off">
                     <input type="hidden" name="_token" value="{{ csrf_token() }}">
                     <input type="hidden" name="mobile_number" value="{{ Session::get('login_mobile') }}">
                     
                      <div class="form-group {{ $errors->first('otp', 'has-error') }}">
                        <input type="text" class="mdl-textfield__input" placeholder="Please enter otp" id="otp" name="otp">
                      </div>
                      <span class="help-block">{{ $errors->first('otp', ':message') }}</span>
                      <div class="clearfix">
