...
@section('header_styles')
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/css/pages/only_dashboard.css') }}"/>
    <meta name="_token" content="{{ csrf_token() }}">
    <link rel="stylesheet" href="{{ asset('public/assets/vendors/morrisjs/morris.css') }}">
    <link rel="stylesheet" href="{{ asset('public/assets/css/pages/dashboard2.css') }}"/>
@stop
                            ...
                            <div class="media">
                                <div class="media-left">
                                    @if($user->pic)
                                        ...
                                        @else
                                            <img src="{!! url('/').'/public/uploads/users/'.$user->pic !!}"
                                                 class="media-object img-circle"/>
                                        @endif
                                    @else
                                        <img src="{{ asset('public/assets/images/authors/no_avatar.jpg') }}" class="media-object img-circle" >
                                     @endif
                                </div>
                                <div class="media-body">
                                    <h5 class="media-heading">{{ ucfirst($user->full_name) }}</h5>
                                    <span class="user_create_date pull-right">{{ $user->created_at->format('d M') }}    <a href="mail:to{{ $user->email }}">{{ $user->email }}</a></span>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="panel-body nopadmar blogs">
                        @foreach($blogs as $blog )
                            <div class="media">
                                <div class="media-left">
                                    @if($blog->author->pic)
                                        <img src="{!! url('/').'/public/uploads/users/'.$blog->author->pic !!}" class="media-object img-circle" >
                                    @else
                                        <img src="{{ asset('public/assets/images/authors/no_avatar.jpg') }}" class="media-object img-circle" >
                                    @endif
                                </div>
...
@section('footer_scripts')
    <script type="text/javascript" src="{{ asset('public/assets/vendors/moment/js/moment.min.js') }}"></script>
    <!--for calendar-->
    <script src="{{ asset('public/assets/vendors/moment/js/moment.min.js') }}" type="text/javascript"></script>
    <!-- Back to Top-->
    <script type="text/javascript" src="{{ asset('public/assets/vendors/countUp_js/js/countUp.js') }}"></script>
    {{--<script src="http://demo.lorvent.com/rare/default/vendors/raphael/js/raphael.min.js"></script>--}}
    <script src="{{ asset('public/assets/vendors/morrisjs/morris.min.js') }}"></script>
