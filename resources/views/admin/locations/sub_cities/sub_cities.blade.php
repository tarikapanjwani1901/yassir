...
<section class="content paddingleft_right15">
    <div class="row">
        <div class="portlet box warning">
            ...
            <input type="search" value="{{$search_keyword}}" name="search_keyword" class="form-control" placeholder="Sub City" style="height: 33px;">
            ...
            {!! Form::select('search_city', $cities,$search_city,['class' => 'form-control search_city', 'id' => 'search_city']) !!}
            {!! Form::select('search_status', $status,$search_status,['class' => 'form-control search_status', 'id' => 'search_status']) !!}
                                                   
            

            <input type="submit" value="Submit">
            <a href="{{url('/admin/sub_cities')}}" data-toggle="tooltip" title="Reset"><i class="fa fa-refresh" aria-hidden="true"></i></a>
        	  </div>
        </form>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($sub_cities as $key => $value) { ?>
                                    <tr id="tr_{{ $value->sub_city_id}}">
                                        ...
                                        <td class="ac">
                                            <a href="sub_cities/edit/{{ $value->sub_city_id}}" class="btn default btn-edit">
                                                Edit
                                            </a>
                                            <a href="#" data-toggle="modal" data-target="#cities_delete_confirm"  data-id="{{ $value->sub_city_id}}" class="onclick default btn btn-delete ">
                                                Delete
                                            </a>
                                        </td>
...
<div class="modal-dialog" role="document" id="cities_delete_confirm" style="display: none;">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="myModalLabel">Delete Sub City</h4>
    </div>
...
<script>
    ...
    jQuery("#btn_ok_1").on('click',function(){
        ...
        $.ajax({
           type:'POST',
           url:'sub_cities/delete/'+DeletedID,
