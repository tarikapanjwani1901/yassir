                ...
                <form method="post" id="addcity" enctype="multipart/form-data">
                            <fieldset>
                                <!-- Name input-->
                                    ...
                                    <div class="form-group row label-floating is-empty">
                                        <label class="control-label col-md-2 col-sm-3" for="city">Sub City <span style="color:red"> * </span> </label>    <div class="col-md-10 col-sm-9">
                                            <select name="sub_city" id="sub_city" class="form-control"><option value="">Please select sub city</option></select>
