    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <form method="post" id="addcities" enctype="multipart/form-data">
                            <fieldset>
                                <!-- Name input-->
                                ...
                                <div class="form-group row label-floating is-empty">
                                        <label class="control-label col-md-2 col-sm-3" for="name">Country <span style="color:red"> * </span> </label>    <div class="col-md-10 col-sm-9">
                                            {!! Form::select('country', $countries, $cities[0]->country_id,['class' => 'form-control select2', 'id' => 'country']) !!}
                                 ...
                                 <div class="form-group row label-floating is-empty">
                                        <label class="control-label col-md-2 col-sm-3" for="name">State <span style="color:red"> * </span> </label>    <div class="col-md-10 col-sm-9">
                                                    {!! Form::select('state', $states,$cities[0]->state_id,['class' => 'form-control select2', 'id' => 'state']) !!}
                                    ...
                                    <div class="form-group row label-floating is-empty">
                                        ...
                                        <input id="name" name="name" type="text" class="form-control" value="{{ $cities[0]->city_name}}" autocomplete="off" required>
                                        </div></div>
                                        
                                        
                                         <div class="form-group row label-floating is-empty">
                                        <label class="control-label col-md-2 col-sm-3" for="name">Status <span style="color:red"> * </span> </label>    <div class="col-md-10 col-sm-9">
                                            {!! Form::select('status', $status, $cities[0]->status,['class' => 'form-control select2', 'id' => 'status']) !!}
