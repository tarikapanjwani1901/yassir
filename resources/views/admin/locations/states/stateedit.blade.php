                                ...
                                <!-- Name input-->
                                 ...
                                 <div class="form-group row label-floating is-empty">
                                        <label class="control-label col-md-2 col-sm-3" for="name">Country <span style="color:red"> * </span> </label>    <div class="col-md-10 col-sm-9">
                                            {!! Form::select('country', $countries, $state[0]->country_id,['class' => 'form-control select2', 'id' => 'countries']) !!}
                                    ...
                                    <div class="form-group row label-floating is-empty">
                                        ...
                                        <input id="name" name="name" type="text" class="form-control" value="{{ $state[0]->name}}" autocomplete="off" required>
                                        </div></div>
                                        
                                         <div class="form-group row label-floating is-empty">
                                        <label class="control-label col-md-2 col-sm-3" for="name">Status <span style="color:red"> * </span> </label>    <div class="col-md-10 col-sm-9">
                                            {!! Form::select('status', $status, $state[0]->status,['class' => 'form-control select2', 'id' => 'status']) !!}
...
<!-- Form actions -->
                            ...
                            <input type="hidden" name="id" value="{{ $state[0]->id}}">
