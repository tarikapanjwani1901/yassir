...
<section class="content-header">
    <h1>Add Popular Categories Listing</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li><a href="#"> Popular Categories Listing</a></li>
        <li class="active">Add Popular Categories Listing</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                <div class="panel-heading">
                    <h4 class="panel-title">Add Popular Categories Listing</h4>
                     @if (session('success'))
                ...
                <form method="post" id="addtestimonail"
                 action="{{url('admin/manage_popular_categories/add')}}">
