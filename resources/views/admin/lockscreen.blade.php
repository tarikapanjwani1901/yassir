...
<head>
    ...
    <link href="{{url('/')}}/public/assets/css/pages/lockscreen.css" rel="stylesheet" />
    <link rel="stylesheet" href="{{url('/')}}/public/assets/vendors/fort_js/css/fort.css" />
    ...
    <div class="login-container">
        ...
        <div>
                ...
                @if(Sentinel::getUser()->pic)
                    <img src="{{ URL::asset('public/uploads/users/'.$user->pic) }}" alt="img"
...
<!-- global js -->
<script src="{{url('/')}}/public/assets/js/jquery-1.11.1.min.js" type="text/javascript"></script>
<!-- Bootstrap -->
<script src="{{url('/')}}/public/assets/js/bootstrap.min.js" type="text/javascript"></script>
<script src="{{url('/')}}/public/assets/js/holder.js"></script>
<!-- end of global js -->
<!-- beginning of page level js-->
<script src="{{url('/')}}/public/assets/vendors/fort_js/js/fort.js"></script>
