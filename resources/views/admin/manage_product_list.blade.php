...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">All Product Listing</li>
    </ol>
</section>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <td>          
                                 ...
                                 <a href="manage_product_list/edit/{{ $property_detail->id }}" class="btn default btn-edit">Edit
                                            </a>      
...
<div class="modal-dialog" role="document" id="tes_delete_confirm" style="display: none;">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="myModalLabel">Delete Product Listing</h4>
    </div>
...
<script>
    ...
    $("#btn_ok_1").on('click',function(){
        ...
        $.ajax({
           type:'POST',
           url:'manage_product_list/delete/'+reviewID,
