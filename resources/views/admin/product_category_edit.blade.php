...
<style>
  ...
  .productimg a.cross{     position: absolute;
    top: 0px;
    right: 1px;
    width: 20px;
    height: 20px;
                        ...
                        <fieldset>
                          ...
                          <div class="form-group row label-floating is-empty">
                           ...
                           <div class="form-group row label-floating is-empty">
                              ...
                              <div class="col-md-10 col-sm-9">
                                 <input id="name" name="name" type="text" class="form-control" value="{{ $cateInfo->cate_name }}" required>
                              </div>
                           </div>
                           <!-- Message body -->
                           <div class="form-group row label-floating is-empty">
                              <label class="control-label col-md-2 col-sm-3" for="message">Description <span style="color:red"> * </span> </label>
                              <div class="col-md-10 col-sm-9">
                                 <textarea class="form-control" id="message" name="message" rows="5" required>{{ $cateInfo->cate_desc }}</textarea>
                              </div>
                           </div>
                           ...
                           <div class="form-group  row label-floating is-empty is-fileinput">
                            ...
                            <?php
                                      $directory = "public/images/product_category/".$cateInfos->cate_id."/";
                                      if (is_dir($directory)) {
                                      ...
                                      foreach ($files as $key => $value) { ?>
                                        ...
                                        <a href="javascript:void(0);" class="cross"> <span class="glyphicon glyphicon-remove f_remove" id="{{$key}}"></span>
                                        </a>
                                        
                                         <img src="/public/images/product_category/{{ $cateInfo->cate_id .'/'. $value }}" id="fimg_{{$key}}">
                                        }
...
$('.f_remove').click(function()
    {
      ...
      $.ajax({
        ...
        url:"{{url('/admin/product/product_del_image')}}",
        data:{file:file},
        dataType: "json",
