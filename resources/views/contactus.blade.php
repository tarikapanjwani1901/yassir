...
<div id="main" class="inner-content  contact-page">
   ...
   <div class="container padd100">
      <div class="row">
               ...
               <table>
                  <tbody>
                     ...
                     <tr>
                        ...
                        <!--<td><a href="tel:7575081000">{{$contact[0]->phone_no}}</a></td>-->
                        <td>
                     ...
                     <tr>
                        ...
                        <td><a href="mailto:{{$contact[0]->email_id}}">{{$contact[0]->email_id}}</a></td>
                     </tr>
                  </tbody>
               </table>
               <tr>
       ...
       @if (session('contact_msgs'))
                        <div class="alert alert-success" id="success-alert">
                            {{ session('contact_msgs') }}
                        </div>
                    @endif
			 <h6>Get In Touch</h6>
