 ...
 <footer>
		    ...
		    <div class="container">
		     <div class="row">
				...
				<div class="col-sm-5 col-md-4 text-right">
				    <a href="{{url('/')}}/contact-us" class="commonbtn">Get in Touch <i class="fa fa-envelope"></i></a>
				</div>
			 </div>
		</div>
	</div>
	...
	<div class="main-footer">
			...
			<div class="col-sm-12 col-md-12">
			   <div class="row footerlinks">
			       <div class="col-sm-3 popular-search-footer">
					 ...
					 <ul>
					    <li><a href="/{{$property_lists->link}}" rel="noreferrer noopener" target="_blank" >{{$property_lists->title}}</a></li>
					 </ul>
					 @endforeach
				  </div>
				  <div class="col-sm-3"><h6>Popular Searches</h6>
					 ...
					 <!-- <ul>
					     <li><a href="/{{$product_lists->link}}" rel="noreferrer noopener" target="_blank" >{{$product_lists->title}}</a></li>
					 </ul>-->
					 @endforeach
				  </div>
				  <div class="col-sm-3"><h6>Popular Searches</h6>
				  	...
				  	@foreach($popular_list as $popular_lists)
					 <!-- <ul>
					    <li><a href="/{{$popular_lists->link}}" rel="noreferrer noopener" target="_blank" >{{$popular_lists->title}}</a></li>
					 </ul>-->
					 @endforeach
				  </div>
				  <div class="col-sm-3"><h6>About</h6>
					 <ul>
						<li><a href="{{url('/services')}}" target="_blank">Services</a></li>
	  ...
	  <div class="scicon text-right">
          	<a class="fb" href="{{$setting[0]->facebook_link}}" target="_blank"><i class="fa fa-facebook"></i> </a>
		   <a class="tw" href="{{$setting[0]->twitter_link}}" target="_blank"><i class="fa fa-twitter"></i> </a>
			 <a class="insta" href="{{$setting[0]->instagram_link}}" target="_blank"><i class="fa fa-instagram"></i> </a>
			 <a class="you" href="{{$setting[0]->youtube_link}}" target="_blank"><i class="fa fa-youtube"></i> </a>
	 </div>
	</div>
	</div>
      </div>
